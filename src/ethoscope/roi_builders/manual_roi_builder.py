...
class ManualROIBuilder(BaseROIBuilder):
    ...
    _description = {"overview": "A flmanual exible ROI builder that allows users to enter directly the coordinates of the ROIs",
                    "arguments": [{"type": "string", "name": f"ROI_{i}", "description": f"Coordinates of ROI {i}. Example (1,1), (2,2), (3,3), (4,4). Four coordinates must be passed","default":1} for i in range(1, NROIS+1)]}
